...
export const MovieCard = (props:Props)=> {
    ...
    return(
        <div className=" flex flex-col items-center max-w-full justify-between gap-3">
        <div className=" flex flex-col items-center gap-3 p-2 bg-slate-700 rounded text-white font-mono w-52 h-full justify-between">
